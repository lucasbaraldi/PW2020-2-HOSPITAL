...
public class TesteListartPaciente {
       ...
       public static void main(String[] args) {
        ...
        for (Paciente p : l){
            System.out.println("ID: " + p.getId() + " Altura: " + p.getAltura() + " Historico: " + p.getHistorico()+ " Nascimento:" 
            + f1.format(p.getNascimento().getTime()) + " Nome: " + p.getNome()+ " Peso: " + p.getPeso() + " Sexo: " + p.getSexo()+ " Telefone: " + p.getTelefone());
        }
